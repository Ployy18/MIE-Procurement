...
class UserService {
  ...
  async createUser(userData: { email: string; password: string; role: string }): Promise<UserDetail> {
  ...
  async updateUser(userData: { id: string; email?: string; role?: string; status?: string }): Promise<UserDetail> {
