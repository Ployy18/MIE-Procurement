      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600 mb-4 shadow-lg shadow-blue-200">
            <img src="/image/Vector.svg" alt="MIE Logo" className="w-12 h-12" />
          </div>
          <h1 className="text-3xl font-normal text-slate-900 tracking-tight text-center">
            Multi Innovation Engineering
            <span className="block font-normal">Procurement</span>
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 p-8 border border-slate-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none text-slate-900 placeholder:text-slate-400"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-3 rounded-full px-6 shadow-lg shadow-blue-100 transition-all duration-200 flex items-center justify-center gap-2"
            >
              {isLoading ? (
          ...
          <div className="mt-8 pt-6 border-t border-slate-50 text-center">
            <p className="text-sm text-slate-400">
              Multi Innovation Engineering Procurement System v0.1
            </p>
          </div>
        </div>
      </div>
